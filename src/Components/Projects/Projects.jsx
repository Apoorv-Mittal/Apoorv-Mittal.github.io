...
const Projects = () =>
    <div className="Article">
        ...
        <p>Contributed to the documentation for Facebook's React.js and added explanations for passing props in the 'Intro to React' page. The PR can be found <a href="https://github.com/facebook/react/pull/10190" target="_blank" rel="noopener noreferrer">here</a>.</p>

        <div className="project-divider"/>

        <h3>
            <a href="https://github.com/philipp-spiess/this-week-in-react" target="_blank" rel="noopener noreferrer">
                this-week-in-react
            </a>
        </h3>
        ...
        <h3>
            <a href="http://taapp.cs.umd.edu" target="_blank" rel="noopener noreferrer">
        ...
        <h3>
            <a href="https://github.com/Apoorv-Mittal/Predicting-Taxi-Fare" target="_blank" rel="noopener noreferrer">
        ...
        <h3>
            <a href="http://tsan.umd.edu/" target="_blank" rel="noopener noreferrer">
                TSAN.UMD.EDU
            </a>
        </h3>
        <p>
        ...
        <h3>
            <a href="https://github.com/Apoorv-Mittal/Chatty-Online-Messaging-App-" target="_blank" rel="noopener noreferrer">
        ...
        <h3>
            <a href="https://github.com/Apoorv-Mittal/Meteor-Landing-Page" target="_blank" rel="noopener noreferrer">
                Meteor-Landing-Page
            </a>
        </h3>
        <p>
